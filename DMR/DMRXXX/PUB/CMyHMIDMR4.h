#ifndef CMYHMIIBCU3240_H
#define CMYHMIIBCU3240_H
...
enum IndexParamUnit
{
	...
	,INDEX_PARAM_MODADDRESS1
	,INDEX_PARAM_CANBAUDRATE1
	,INDEX_PARAM_MODADDRESS2
	,INDEX_PARAM_CANBAUDRATE2
	,INDEX_PARAM_SCIBAUDRATE
	,INDEX_PARAM_ADDRIP1
	,INDEX_PARAM_ADDRMASK1
// 	,INDEX_PARAM_GETWAY1
	,INDEX_PARAM_ADDRIP2
	,INDEX_PARAM_ADDRMASK2
// 	,INDEX_PARAM_GETWAY2
	,INDEX_PARAM_ALARMKM
...
//-----------------------------------------------------------------------------
#undef CLASSNAME_HMI
#define CLASSNAME_HMI CMyHMIiBCU3240
class CMyHMIiBCU3240:public CMyHMIDMR
{
public:
	void OnInit(void);
	void OnTimer10ms(void);
// 	void OnWhileLoop(void);
	void OnRefreshPage(WORD wRefreshMode);
public:
