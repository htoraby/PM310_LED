...
{
	{"选项:电动机保护",	"OPT:\1MOTOR PROTECT"},
	{"选项:方向闭锁",	"OPT:\1DIRECT BLOCK"},
	{"选项:低压闭锁",	"OPT:\1UNDERVOL BLOCK"},
	{NULL,				NULL},
	{NULL,				NULL},
	{NULL,				NULL},
	{NULL,				NULL},
...
{
	{"电流速断",		"OVERCUR INSTANT",		PROTECTACT_IP},
	{"限时电流速断",	"OVERCUR HIGH",			PROTECTACT_IP},
	{"定时限过流",		"OVERCUR LOW",			PROTECTACT_IP},
	{"反时限过流",		"OVERCUR IDMT",			PROTECTACT_IP},
	{"后加速",			"ACC. TRIP",			PROTECTACT_IP},
	{"过负荷",			"OVERLOAD",				PROTECTACT_IP},
	{"负序电流",		"NEG OVERCUR",			PROTECTACT_IP},
	{"零序电流",		"RES OVERCUR",			PROTECTACT_3I0},
	{"单相接地选线",	"E-FAULT DETECT",		PROTECTACT_3I0},
	{"过电压",			"OVERVOLTAGE",			PROTECTACT_U},
	{"低电压",			"UNDERVOLTAGE",			PROTECTACT_U},
	{"失压",			"PRI. PWR FAULT",		PROTECTACT_U},
	{"负序电压",		"NEG OVERVOLTAGE",		PROTECTACT_U},
	{"零序电压",		"RES OVERVOLTAGE",		PROTECTACT_3U0},
	{"复合电压过流",	"COMP. OVERCUR",		PROTECTACT_IP},
	{"低周减载",		"UNDERFREQENCY",		PROTECTACT_F},
	{"低压解列",		"U-VOL DECOUPLING",		PROTECTACT_U},
	{"重合闸",			"AUTO-RECLOSURE",		PROTECTACT_NULL},
	{"备自投",			"AUTO-SWITCHING",		PROTECTACT_NULL},
	{"过热",			"THERMAL OVERLOAD",		PROTECTACT_IP},
	{"逆功率",			"REVERSE POWER",		PROTECTACT_P},
	{"启动时间过长",	"MOTOR START TIME",		PROTECTACT_NULL},
	{"定时限Ix过流",	"Ix OVERCUR ",			PROTECTACT_Ix},
	{"反时限Ix过流",	"Ix OVERCUR IDMT",		PROTECTACT_Ix},
	{NULL,				NULL,					PROTECTACT_NULL},
	{NULL,				NULL,					PROTECTACT_NULL},
	{NULL,				NULL,					PROTECTACT_NULL},
	{NULL,				NULL,					PROTECTACT_NULL},
