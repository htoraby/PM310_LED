...
#define DM9000_RX_INTR        0x01                // bit 
#define DM9000_TX_INTR        0x02                // bit 
#define DM9000_OVERFLOW_INTR  0x04                // bit
#define DM9000_LINK_CHANG     0x20                // bit 

#define DM9000_PHY_SET        0x00                // PHY 
#define DM9000_PHY_OFF        0x01                // PHY 
#define DM9000_RCR_SET        0x31                // CRC 
#define DM9000_TCR_SET        0x01                
#define DM9000_RCR_OFF        0x00                
#define DM9000_BPTR_SET       0x37                // Back Pressure  
#define DM9000_FCTR_SET       0x38                // Flow Control 
#define DM9000_TCR2_SET       0x80                
#define DM9000_OTCR_SET       0x80                // DM9000  0x80 = 100Mhz 
#define DM9000_ETXCSR_SET     0x83                
#define DM9000_FCR_SET        0x28               
#define DM9000_TCSCR_SET      0x07                
#define DM9000_RCSCSR_SET     0x03                
#define DM9000_IMR_SET        0x81                
...
//#define DM9K_ADDR		((*((volatile WORD *)m_dwBaseAddr)))
//#define DM9K_DATA		((*((volatile WORD *)(m_dwBaseAddr+1))))
#define DM9K_ADDR		(*((volatile WORD *)0x002008))
#define DM9K_DATA		(*((volatile WORD *)0x002009))
...
public:
	...
	BYTE ior(BYTE Reg);
	void iow(BYTE Reg, WORD wData);
	void Reset(void);
	void PHY_Write(WORD wPHY_Reg, WORD wData);
	void OnTimer10ms(void);
public:
	void OnInitHardware(void);
	void OnInit(WORD wSpeedMode=1);
	void OnInitStatus(void);
// 	void OnInit(BYTE MACAddr6,WORD wSpeedMode=1);		// 0x01,default:Auto-negotiation
										// 0x02:10M
										// 0x03:100M
	void ModifyAddrMac(BYTE MACAddr6);
