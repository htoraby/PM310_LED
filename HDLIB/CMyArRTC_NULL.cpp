...
///----------------------------------------------------------------------------
BOOL CMyArRTC_NULL::IsError(void)
{
/*	BYTE Temp[2];
...
void CMyArRTC_NULL::ReadTime(DEVICETIME* pDeviceTime)
{
/*	BYTE Temp[11];
	BYTE TempYear;
...
void CMyArRTC_NULL::WriteTime(DEVICETIME* pDeviceTime)
{
/*	BYTE Temp[11];
	Temp[0] = 0x00;
...
void CMyArRTC_NULL::iiiReadDataByte(DWORD dwAddr,BYTE* pData,WORD wCountByte)
{
/*	if(dwAddr+wCountByte>RTC_DATA_COUNTBYTE) return;
	g_i2c.ReadDataByte(RTC_DEV_ADDR,(WORD)(RTC_DATA_ADDR+dwAddr),pData,wCountByte);*/
}

void CMyArRTC_NULL::iiiReadDataWord(DWORD dwAddr,WORD* pData,WORD wCountWord)
{
...
void CMyArRTC_NULL::iiiWriteDataByte(DWORD dwAddr,BYTE* pData,WORD wCountByte)
{
/*	if(dwAddr+wCountByte>RTC_DATA_COUNTBYTE) return;
	g_i2c.WriteDataByte(RTC_DEV_ADDR,(WORD)(RTC_DATA_ADDR+dwAddr),pData,wCountByte);*/
}

void CMyArRTC_NULL::iiiWriteDataWord(DWORD dwAddr,WORD* pData,WORD wCountWord)
{
/*	if(dwAddr+wCountWord*2>RTC_DATA_COUNTBYTE) return;
